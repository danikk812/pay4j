...
<html>
<head>
    <title>PAY4J: ${locale_sign_up}</title>
</head>
<body>
                ...
                <form action="Controller" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="login" id="loginInput" required
                               pattern="${attribute_regexp_login}" placeholder="${locale_from} 6 ${locale_to} 16 ${locale_letters}/${locale_digits} ${locale_and} '_'">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" id="nameInput" required
                               pattern="${attribute_regexp_fullname}" placeholder="${locale_from} 2 ${locale_to} 20 ${locale_letters}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="patronymicInput">${locale_user_patronymic}:</label>
                        <input type="text" class="form-control" name="patronymic" id="patronymicInput" required
                               pattern="${attribute_regexp_fullname}" placeholder="${locale_from} 2 ${locale_to} 20 ${locale_letters}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" class="form-control" name="phone" id="phoneInput" required
                               pattern="${attribute_regexp_phone}" placeholder="${locale_format}: +000123456789">
                    </div>
