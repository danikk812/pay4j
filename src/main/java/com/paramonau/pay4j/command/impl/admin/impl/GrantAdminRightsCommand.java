...
public class GrantAdminRightsCommand extends AdminCommand {

    private static final Logger logger = Logger.getLogger(GrantAdminRightsCommand.class);
    ...
    protected Router process(HttpServletRequest req) {
        ...
        try {
            userService.updateStatus(userId, ADMIN_STATUS);
